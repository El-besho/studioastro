...
export const automotiveServices: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'mobile-car-wash', ar_name: 'غسيل سيارات متنقل بالبخار', urgency: 'scheduled', avg_price_range: [70, 200], skill_requirements: ['car_detailer'], tools_required: ['steam_cleaner', 'microfiber_towels'], seasonal_multiplier: 1.1, seo: { summary: "غسيل سيارات متنقل بالبخار صديق للبيئة يأتي إلى موقعك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'mobile-oil-change', ar_name: 'تغيير زيت وفلاتر متنقل', urgency: 'maintenance', avg_price_range: [200, 450], skill_requirements: ['mechanic'], tools_required: ['oil_extractor_pump', 'drain_pan'], seasonal_multiplier: 1.0, seo: { summary: "خدمة تغيير زيت وفلاتر متنقلة مريحة في منزلك أو مكتبك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'roadside-assistance', ar_name: 'خدمة المساعدة على الطريق (بطارية، بنشر)', urgency: 'emergency', avg_price_range: [200, 500], skill_requirements: ['roadside_technician'], tools_required: ['tow_truck', 'jumper_cables', 'tire_iron'], seasonal_multiplier: 1.2, seo: { summary: "مساعدة على الطريق على مدار 24 ساعة لبدء تشغيل البطارية وتغيير الإطارات المثقوبة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'battery-replacement', ar_name: 'تغيير البطارية في الموقع', urgency: 'emergency', avg_price_range: [300, 600], skill_requirements: ['mechanic'], tools_required: ['battery_tester', 'socket_wrench_set'], seasonal_multiplier: 1.1, seo: { summary: "استبدال بطارية السيارة في الموقع لإعادتك إلى الطريق بسرعة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'brake-pad-replacement', ar_name: 'تغيير فحمات الفرامل متنقل', urgency: 'urgent', avg_price_range: [400, 800], skill_requirements: ['certified_mechanic'], tools_required: ['brake_caliper_tool', 'torque_wrench'], seasonal_multiplier: 1.0, seo: { summary: "استبدال فحمات الفرامل المتنقلة لراحتك وسلامتك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'car-checkup', ar_name: 'فحص كمبيوتر للسيارات متنقل', urgency: 'urgent', avg_price_range: [150, 300], skill_requirements: ['mechanic'], tools_required: ['obd2_scanner'], seasonal_multiplier: 1.0, seo: { summary: "فحص تشخيصي كمبيوتر متنقل للسيارة لتحديد المشكلات واستكشافها وإصلاحها.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
