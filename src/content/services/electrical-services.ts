...
export const electricalServices: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'light_install', ar_name: 'تركيب إضاءة وثريات', en_name: 'Lighting and Chandelier Installation', urgency: 'scheduled', avg_price_range: [200, 600], skill_requirements: ['licensed_electrician'], tools_required: ['ladder', 'wire_stripper'], seasonal_multiplier: 1.1, seo: { summary: "تركيب احترافي لجميع أنواع وحدات الإضاءة، بما في ذلك الثريات والأضواء المعلقة والمصابيح الموجهة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'fault_repair', ar_name: 'إصلاح الأعطال والماس الكهربائي', en_name: 'Electrical Fault and Short Circuit Repair', urgency: 'emergency', avg_price_range: [250, 700], skill_requirements: ['master_electrician'], tools_required: ['multimeter', 'circuit_tester'], seasonal_multiplier: 1.2, seo: { summary: "خدمة طوارئ على مدار 24 ساعة للأعطال الكهربائية والماس الكهربائي لضمان سلامة منزلك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'outlet_install', ar_name: 'تركيب وتغيير أفياش ومقابس', en_name: 'Socket and Outlet Installation/Replacement', urgency: 'scheduled', avg_price_range: [150, 300], skill_requirements: ['licensed_electrician'], tools_required: ['drill', 'wire_cutter'], seasonal_multiplier: 1.0, seo: { summary: "تركيب واستبدال المقابس والمآخذ والمفاتيح الكهربائية للسلامة والراحة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'panel_upgrade', ar_name: 'تغيير وتحديث لوحة التوزيع (الطبلون)', en_name: 'Distribution Panel Upgrade', urgency: 'scheduled', avg_price_range: [800, 2500], skill_requirements: ['master_electrician'], tools_required: ['breaker_puller', 'torque_wrench'], seasonal_multiplier: 1.1, seo: { summary: "قم بترقية لوحة الكهرباء الخاصة بك لدعم المزيد من الأجهزة وتحسين السلامة في منزلك أو مكتبك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'wiring_inspection', ar_name: 'فحص وتدقيق التمديدات الكهربائية', en_name: 'Electrical Wiring Inspection', urgency: 'maintenance', avg_price_range: [400, 800], skill_requirements: ['master_electrician'], tools_required: ['insulation_tester', 'thermal_camera'], seasonal_multiplier: 1.0, seo: { summary: "فحص شامل للأسلاك الكهربائية لتحديد المخاطر المحتملة وضمان الامتثال لمعايير السلامة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'generator_install', ar_name: 'تركيب مولدات كهربائية احتياطية', en_name: 'Backup Generator Installation', urgency: 'scheduled', avg_price_range: [2000, 7000], skill_requirements: ['certified_electrician'], tools_required: ['transfer_switch', 'heavy_gauge_cable'], seasonal_multiplier: 1.0, seo: { summary: "تركيب مولدات احتياطية لتوفير طاقة غير منقطعة أثناء انقطاع التيار الكهربائي.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'ceiling_fan_install', ar_name: 'تركيب مراوح سقف', en_name: 'Ceiling Fan Installation', urgency: 'scheduled', avg_price_range: [200, 400], skill_requirements: ['electrician'], tools_required: ['ladder', 'drill'], seasonal_multiplier: 1.1, seo: { summary: "تركيب مراوح السقف لتحسين دوران الهواء وتقليل تكاليف التبريد.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
