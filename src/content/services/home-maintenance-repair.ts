...
export const homeMaintenanceRepair: ServiceHierarchy = {
    ...
    sub_services: [
      ...
      { id: 'furniture_assembly', ar_name: 'تجميع وتركيب الأثاث (ايكيا وغيرها)', urgency: 'scheduled', avg_price_range: [200, 500], skill_requirements: ['handyman'], tools_required: ['ikea_tool_kit', 'drill'], seasonal_multiplier: 1.2, seo: { summary: "تجميع احترافي للأثاث من ايكيا وغيرها من العلامات التجارية.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      ...
      { id: 'hanging_pictures_shelves', ar_name: 'تركيب ستائر ولوحات ورفوف', urgency: 'scheduled', avg_price_range: [100, 250], skill_requirements: ['handyman'], tools_required: ['drill', 'level', 'stud_finder'], seasonal_multiplier: 1.0, seo: { summary: "تعليق آمن للستائر والصور والرفوف لإكمال ديكور منزلك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
