...
export const homeMaintenanceRepair: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'carpentry', ar_name: 'أعمال النجارة (أبواب، خزائن)', Cabinets)', urgency: 'scheduled', avg_price_range: [300, 800], skill_requirements: ['master_carpenter'], tools_required: ['saw', 'drill', 'sander'], seasonal_multiplier: 1.0, seo: { summary: "خدمات نجارة مخصصة للأبواب والخزائن والتركيبات الخشبية الأخرى.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'door_window_repair', ar_name: 'تركيب وإصلاح الأبواب والشبابيك', urgency: 'urgent', avg_price_range: [250, 600], skill_requirements: ['carpenter', 'glazier'], tools_required: ['chisel', 'level'], seasonal_multiplier: 1.1, seo: { summary: "تركيب وإصلاح الأبواب والنوافذ لتحسين الأمن والعزل.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'furniture_assembly', ar_name: 'تجميع وتركيب الأثاث (ايكيا وغيرها)', etc.)', urgency: 'scheduled', avg_price_range: [200, 500], skill_requirements: ['handyman'], tools_required: ['ikea_tool_kit', 'drill'], seasonal_multiplier: 1.2, seo: { summary: "تجميع احترافي للأثاث من ايكيا وغيرها من العلامات التجارية.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'drywall_repair', ar_name: 'إصلاح الجدران والجبس بورد', urgency: 'scheduled', avg_price_range: [200, 500], skill_requirements: ['drywall_finisher'], tools_required: ['putty_knife', 'sanding_block'], seasonal_multiplier: 1.0, seo: { summary: "إصلاح الثقوب والشقوق في الجدران الجافة وألواح الجبس للحصول على لمسة نهائية ناعمة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      ...
      { id: 'hanging_pictures_shelves', ar_name: 'تركيب ستائر ولوحات ورفوف', Pictures, and Shelves', urgency: 'scheduled', avg_price_range: [100, 250], skill_requirements: ['handyman'], tools_required: ['drill', 'level', 'stud_finder'], seasonal_multiplier: 1.0, seo: { summary: "تعليق آمن للستائر والصور والرفوف لإكمال ديكور منزلك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
