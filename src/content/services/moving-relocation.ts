...
export const movingRelocation: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'local_moving', ar_name: 'نقل أثاث داخل المدينة', en_name: 'Local Furniture Moving', urgency: 'scheduled', avg_price_range: [800, 2500], skill_requirements: ['professional_mover'], tools_required: ['moving_truck', 'dolly', 'blankets'], seasonal_multiplier: 1.4, seo: { summary: "خدمات نقل أثاث محلية موثوقة لنقل خالٍ من المتاعب داخل مدينتك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'intercity_moving', ar_name: 'نقل أثاث بين المدن', en_name: 'Inter-city Furniture Moving', urgency: 'scheduled', avg_price_range: [2000, 6000], skill_requirements: ['long_distance_mover'], tools_required: ['large_truck', 'straps'], seasonal_multiplier: 1.3, seo: { summary: "نقل أثاث سلس بين المدن إلى أي مكان في المملكة العربية السعودية.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'furniture_packing', ar_name: 'تغليف وتعبئة الأثاث', en_name: 'Furniture Packing and Wrapping', urgency: 'scheduled', avg_price_range: [500, 1500], skill_requirements: ['packer'], tools_required: ['boxes', 'bubble_wrap', 'tape'], seasonal_multiplier: 1.2, seo: { summary: "تغليف وتعبئة أثاث احترافي لحماية ممتلكاتك أثناء النقل.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'furniture_storage', ar_name: 'تخزين الأثاث', en_name: 'Furniture Storage', urgency: 'scheduled', avg_price_range: [400, 1000], skill_requirements: ['storage_facility_operator'], tools_required: ['climate_controlled_unit', 'security_system'], seasonal_multiplier: 1.1, seo: { summary: "تخزين أثاث آمن ومكيف للاحتياجات قصيرة أو طويلة الأجل.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'office_relocation', ar_name: 'نقل المكاتب والشركات', en_name: 'Office and Corporate Relocation', urgency: 'scheduled', avg_price_range: [3000, 15000], skill_requirements: ['commercial_mover'], tools_required: ['it_equipment_crates', 'labeling_system'], seasonal_multiplier: 1.0, seo: { summary: "خدمات نقل مكاتب وشركات فعالة لتقليل وقت التوقف عن العمل.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'heavy_item_moving', ar_name: 'نقل الأغراض الثقيلة (خزائن، بيانو)', en_name: 'Heavy Item Moving (Safes, Pianos)', urgency: 'scheduled', avg_price_range: [500, 2000], skill_requirements: ['specialized_mover'], tools_required: ['heavy_duty_dolly', 'crane'], seasonal_multiplier: 1.0, seo: { summary: "خدمات نقل متخصصة للأشياء الثقيلة والحساسة مثل الخزائن والبيانو.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
