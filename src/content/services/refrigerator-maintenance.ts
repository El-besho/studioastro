...
export const refrigeratorMaintenance: ServiceHierarchy = {
    ...
    sub_services: [
        { id: 'refrigerator-cooling-repair', ar_name: 'إصلاح مشاكل التبريد', urgency: 'emergency', avg_price_range: [250, 600], skill_requirements: ['refrigeration_technician'], tools_required: ['multimeter', 'freon_gauge'], seasonal_multiplier: 1.3, seo: { summary: "إصلاح سريع لمشاكل التبريد في الثلاجات والفريزرات، وفحص شامل لمستويات الفريون والضاغط.", primary_keywords: ["الثلاجة لا تبرد", "إصلاح تبريد الثلاجة"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'refrigerator-water-leak-repair', ar_name: 'إصلاح تسرب المياه من الثلاجة', urgency: 'urgent', avg_price_range: [200, 400], skill_requirements: ['refrigeration_technician'], tools_required: ['drain_snake', 'pan_replacement'], seasonal_multiplier: 1.1, seo: { summary: "إصلاح تسربات المياه الناتجة عن انسداد خطوط التصريف أو مشاكل في وعاء التبخير.", primary_keywords: ["الثلاجة تسرب ماء"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'freezer-repair', ar_name: 'إصلاح الفريزرات', urgency: 'emergency', avg_price_range: [300, 700], skill_requirements: ['refrigeration_technician'], tools_required: ['multimeter', 'thermostat'], seasonal_multiplier: 1.2, seo: { summary: "خدمات إصلاح متخصصة لجميع أنواع الفريزرات المنزلية والتجارية، بما في ذلك مشاكل التجميد وتراكم الثلج.", primary_keywords: ["تصليح فريزر", "صيانة فريزرات"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'commercial-refrigerator-repair', ar_name: 'صيانة ثلاجات العرض التجارية', urgency: 'urgent', avg_price_range: [400, 1000], skill_requirements: ['commercial_refrigeration_expert'], tools_required: ['commercial_compressor_tools', 'refrigerant_scale'], seasonal_multiplier: 1.1, seo: { summary: "صيانة وإصلاح ثلاجات العرض للمحلات التجارية والسوبر ماركت لضمان استمرارية عملك.", primary_keywords: ["صيانة ثلاجات عرض"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'water-cooler-repair', ar_name: 'إصلاح البرادات', urgency: 'urgent', avg_price_range: [200, 450], skill_requirements: ['refrigeration_technician'], tools_required: ['dispenser_valve', 'thermostat'], seasonal_multiplier: 1.2, seo: { summary: "إصلاح وصيانة جميع أنواع برادات المياه المنزلية والمكتبية، وحل مشاكل التبريد والتسريب.", primary_keywords: ["صيانة برادات", "تصليح برادة"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'refrigerator-general-maintenance', ar_name: 'صيانة عامة للثلاجات', urgency: 'maintenance', avg_price_range: [200, 350], skill_requirements: ['appliance_technician'], tools_required: ['coil_brush', 'multimeter'], seasonal_multiplier: 1.0, seo: { summary: "خدمة صيانة دورية للثلاجات تشمل تنظيف المكثف، فحص الأختام، والتأكد من عمل جميع المكونات بكفاءة لإطالة عمر الجهاز.", primary_keywords: ["صيانة ثلاجات دورية"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
};
