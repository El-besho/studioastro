...
export const washingMachineMaintenance: ServiceHierarchy = {
    ...
    sub_services: [
        { id: 'automatic-washer-repair', ar_name: 'إصلاح الغسالات الأوتوماتيك (تحميل أمامي)', urgency: 'urgent', avg_price_range: [250, 600], skill_requirements: ['appliance_technician'], tools_required: ['multimeter', 'socket_set'], seasonal_multiplier: 1.2, seo: { summary: "إصلاح متخصص للغسالات الأوتوماتيك ذات التحميل الأمامي، بما في ذلك مشاكل الباب، الصرف، والبرامج.", primary_keywords: ["صيانة غسالات اتوماتيك", "تصليح غسالة اتوماتيك"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'top-load-washer-repair', ar_name: 'إصلاح الغسالات فوق الأوتوماتيك (تحميل علوي)', urgency: 'urgent', avg_price_range: [200, 500], skill_requirements: ['appliance_technician'], tools_required: ['multimeter', 'agitator_puller'], seasonal_multiplier: 1.1, seo: { summary: "إصلاح سريع للغسالات فوق الأوتوماتيك، بما في ذلك مشاكل الدوران، تعبئة المياه، والأعطال الميكانيكية.", primary_keywords: ["صيانة غسالات فوق اتوماتيك"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'washer-dryer-combo-repair', ar_name: 'إصلاح الغسالات مع مجفف', urgency: 'urgent', avg_price_range: [350, 800], skill_requirements: ['certified_appliance_technician'], tools_required: ['heating_element_tester', 'belt_tool'], seasonal_multiplier: 1.2, seo: { summary: "صيانة وإصلاح متخصص للغسالات المدمجة مع مجفف، بما في ذلك مشاكل التجفيف والبرامج المعقدة.", primary_keywords: ["صيانة غسالة مع مجفف"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'dishwasher-repair', ar_name: 'إصلاح غسالات الصحون', urgency: 'urgent', avg_price_range: [300, 650], skill_requirements: ['appliance_technician'], tools_required: ['water_inlet_valve', 'pump_assembly'], seasonal_multiplier: 1.0, seo: { summary: "إصلاح جميع أنواع غسالات الصحون، بما في ذلك مشاكل عدم التنظيف، تسرب المياه، ومشاكل الصرف.", primary_keywords: ["صيانة غسالة صحون", "تصليح جلايات"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'dryer-repair', ar_name: 'إصلاح مجففات الملابس (النشافات)', urgency: 'urgent', avg_price_range: [250, 500], skill_requirements: ['appliance_technician'], tools_required: ['heating_element_tester', 'belt_tool'], seasonal_multiplier: 1.1, seo: { summary: "خدمات إصلاح لجميع أنواع مجففات الملابس، بما في ذلك مشاكل عدم التسخين، الأصوات الغريبة، أو مشاكل الدوران.", primary_keywords: ["تصليح نشافات", "صيانة مجفف حراري"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
        { id: 'washing-machine-general-maintenance', ar_name: 'صيانة عامة للغسالات', urgency: 'maintenance', avg_price_range: [200, 300], skill_requirements: ['appliance_technician'], tools_required: ['drain_cleaner', 'level'], seasonal_multiplier: 1.0, seo: { summary: "فحص وصيانة دورية للغسالة تشمل تنظيف الفلتر، فحص الخراطيم، والتأكد من توازن الحوض للحفاظ على أداء الغسالة ومنع الأعطال.", primary_keywords: ["صيانة غسالات دورية"], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
};
