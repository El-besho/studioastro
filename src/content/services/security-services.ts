...
export const securityServices: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'cctv_install', ar_name: 'تركيب كاميرات مراقبة CCTV', urgency: 'scheduled', avg_price_range: [1000, 5000], skill_requirements: ['security_technician'], tools_required: ['drill', 'cable_crimper'], seasonal_multiplier: 1.1, seo: { summary: "تركيب احترافي لكاميرات المراقبة لمراقبة كاملة لممتلكاتك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      ...
      { id: 'smart_lock_install', ar_name: 'تركيب أقفال الأبواب الذكية', urgency: 'scheduled', avg_price_range: [500, 1200], skill_requirements: ['locksmith', 'it_basics'], tools_required: ['drill', 'chisel'], seasonal_multiplier: 1.0, seo: { summary: "قم بترقية أمنك من خلال تركيب قفل ذكي للدخول بدون مفتاح والوصول عن بعد.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'intercom_install', ar_name: 'تركيب أنظمة الاتصال الداخلي (انتركم)', urgency: 'scheduled', avg_price_range: [800, 2500], skill_requirements: ['security_technician'], tools_required: ['cable_tester', 'wire_puller'], seasonal_multiplier: 1.0, seo: { summary: "تركيب أنظمة الاتصال الداخلي للاتصال المريح والآمن.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'fire_alarm_install', ar_name: 'تركيب أنظمة إنذار الحريق', urgency: 'urgent', avg_price_range: [2000, 8000], skill_requirements: ['fire_safety_engineer'], tools_required: ['smoke_detector_tester', 'control_panel'], seasonal_multiplier: 1.1, seo: { summary: "تركيب أنظمة إنذار الحريق لضمان الكشف المبكر والسلامة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
