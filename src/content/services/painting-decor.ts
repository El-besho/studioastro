...
export const paintingDecor: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'interior_painting', ar_name: 'دهانات داخلية', en_name: 'Interior Painting', urgency: 'scheduled', avg_price_range: [2000, 8000], skill_requirements: ['professional_painter'], tools_required: ['roller', 'brushes', 'scaffolding'], seasonal_multiplier: 1.3, seo: { summary: "دهان داخلي عالي الجودة لتجديد مظهر منزلك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'exterior_painting', ar_name: 'دهانات خارجية وواجهات', en_name: 'Exterior and Facade Painting', urgency: 'scheduled', avg_price_range: [5000, 20000], skill_requirements: ['exterior_painter'], tools_required: ['spray_gun', 'pressure_washer'], seasonal_multiplier: 1.1, seo: { summary: "دهان خارجي متين لحماية وتجميل واجهة الممتلكات الخاصة بك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'wallpaper_install', ar_name: 'تركيب ورق جدران', en_name: 'Wallpaper Installation', urgency: 'scheduled', avg_price_range: [800, 3000], skill_requirements: ['wallpaper_hanger'], tools_required: ['smoothing_tool', 'seam_roller'], seasonal_multiplier: 1.2, seo: { summary: "تركيب ورق جدران متخصص لتصميم داخلي أنيق وفريد.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'decorative_painting', ar_name: 'دهانات ديكورية (تعتيق، ترخيم)', en_name: 'Decorative Painting (Antiquing, Marbling)', urgency: 'scheduled', avg_price_range: [3000, 10000], skill_requirements: ['decorative_artist'], tools_required: ['sponges', 'glazes', 'specialty_brushes'], seasonal_multiplier: 1.2, seo: { summary: "تقنيات دهان زخرفية مخصصة مثل التعتيق والترخيم للحصول على لمسة نهائية فاخرة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'gypsum_board_decor', ar_name: 'أعمال ديكورات جبس بورد', en_name: 'Gypsum Board Decor Works', urgency: 'scheduled', avg_price_range: [1500, 7000], skill_requirements: ['gypsum_carpenter'], tools_required: ['drywall_saw', 'screw_gun'], seasonal_multiplier: 1.1, seo: { summary: "ديكورات جبس بورد إبداعية للأسقف والجدران.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'furniture_painting', ar_name: 'دهان الأبواب والأثاث الخشبي', en_name: 'Doors and Wooden Furniture Painting', urgency: 'scheduled', avg_price_range: [500, 2000], skill_requirements: ['furniture_finisher'], tools_required: ['sander', 'spray_gun'], seasonal_multiplier: 1.0, seo: { summary: "إعادة طلاء ودهان الأبواب والأثاث الخشبي لاستعادة جمالها.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
