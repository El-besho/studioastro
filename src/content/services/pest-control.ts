...
export const pestControl: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'termite_control', ar_name: 'مكافحة النمل الأبيض (الأرضة)', en_name: 'Termite Control', urgency: 'urgent', avg_price_range: [800, 2500], skill_requirements: ['pest_control_certified'], tools_required: ['termiticide_injector', 'moisture_meter'], seasonal_multiplier: 1.4, seo: { summary: "مكافحة شاملة للنمل الأبيض لحماية الممتلكات الخاصة بك من الأضرار الهيكلية.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'pre_construction_termite_treatment', ar_name: 'رش الدفان قبل البناء', en_name: 'Pre-construction Termite Treatment', urgency: 'scheduled', avg_price_range: [10, 25], skill_requirements: ['pest_control_certified', 'construction_site_safety'], tools_required: ['high_pressure_sprayer', 'soil_injector'], seasonal_multiplier: 1.0, seo: { summary: "خدمة رش الدفان والمبيدات قبل صبة النظافة لحماية أساسات المباني الجديدة من هجمات النمل الأبيض المستقبلية.", primary_keywords: ["رش الدفان", "مكافحة النمل الأبيض قبل البناء"], secondary_keywords: ["رش مبيد قبل الصبة", "علاج الأرضة قبل البناء"], long_tail_keywords: ["أفضل مبيد للدفان", "سعر رش الدفان للمتر"], faq: [] } },
      { id: 'cockroach_control', ar_name: 'مكافحة الصراصير', en_name: 'Cockroach Control', urgency: 'urgent', avg_price_range: [250, 500], skill_requirements: ['pest_control_certified'], tools_required: ['bait_gun', 'gel_bait'], seasonal_multiplier: 1.2, seo: { summary: "إبادة فعالة للصراصير من أجل بيئة صحية خالية من الآفات.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'bed_bug_control', ar_name: 'مكافحة بق الفراش', en_name: 'Bed Bug Control', urgency: 'emergency', avg_price_range: [500, 1500], skill_requirements: ['bed_bug_specialist'], tools_required: ['steamer', 'diatomaceous_earth'], seasonal_multiplier: 1.3, seo: { summary: "معالجة شاملة لبق الفراش لضمان نوم هانئ ليلاً.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'rodent_control', ar_name: 'مكافحة القوارض (الفئران والجرذان)', en_name: 'Rodent Control (Mice and Rats)', urgency: 'emergency', avg_price_range: [300, 600], skill_requirements: ['pest_control_certified'], tools_required: ['traps', 'bait_stations'], seasonal_multiplier: 1.1, seo: { summary: "مكافحة إنسانية وفعالة للقوارض للحفاظ على منزلك أو عملك آمنًا.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'ant_control', ar_name: 'مكافحة النمل', en_name: 'Ant Control', urgency: 'urgent', avg_price_range: [200, 400], skill_requirements: ['pest_control_technician'], tools_required: ['gel_bait', 'sprayer'], seasonal_multiplier: 1.0, seo: { summary: "حلول مستهدفة لمكافحة النمل للقضاء على المستعمرات ومنع الإصابات المستقبلية.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'bird_control', ar_name: 'مكافحة الطيور والحمام', en_name: 'Bird and Pigeon Control', urgency: 'scheduled', avg_price_range: [500, 2000], skill_requirements: ['bird_control_specialist'], tools_required: ['spikes_installation_kit', 'netting_tools'], seasonal_multiplier: 1.0, seo: { summary: "مكافحة إنسانية للطيور والحمام لحماية الممتلكات الخاصة بك من التلف والفوضى.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
