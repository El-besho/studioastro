...
export const itTechServices: ServiceHierarchy = {
    ...
    sub_services: [
      { id: 'pc_maintenance', ar_name: 'صيانة وإصلاح أجهزة الكمبيوتر', en_name: 'Computer Maintenance and Repair', urgency: 'urgent', avg_price_range: [250, 600], skill_requirements: ['it_support_specialist'], tools_required: ['diagnostic_software', 'anti_static_wrist_strap'], seasonal_multiplier: 1.0, seo: { summary: "صيانة وإصلاح شامل للكمبيوتر للحفاظ على تشغيل أجهزتك بسلاسة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'data_recovery', ar_name: 'استعادة البيانات المحذوفة', en_name: 'Data Recovery', urgency: 'emergency', avg_price_range: [800, 3000], skill_requirements: ['data_recovery_expert'], tools_required: ['clean_room', 'specialized_software'], seasonal_multiplier: 1.1, seo: { summary: "خدمات استعادة بيانات احترافية لاسترداد الملفات المفقودة أو المحذوفة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'wifi_install_optimization', ar_name: 'تركيب وتقوية شبكات الواي فاي', en_name: 'WiFi Network Installation and Optimization', urgency: 'scheduled', avg_price_range: [400, 1200], skill_requirements: ['network_technician'], tools_required: ['cable_tester', 'wifi_analyzer'], seasonal_multiplier: 1.0, seo: { summary: "تركيب وتحسين شبكة WiFi لتغطية إنترنت قوية وموثوقة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'virus_malware_removal', ar_name: 'إزالة الفيروسات والبرامج الضارة', en_name: 'Virus & Malware Removal', urgency: 'urgent', avg_price_range: [200, 500], skill_requirements: ['security_specialist'], tools_required: ['antivirus_software', 'firewall_setup'], seasonal_multiplier: 1.1, seo: { summary: "إزالة شاملة للفيروسات والبرامج الضارة لحماية أجهزتك وبياناتك.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'printer_repair', ar_name: 'صيانة الطابعات', en_name: 'Printer Repair', urgency: 'urgent', avg_price_range: [150, 400], skill_requirements: ['printer_technician'], tools_required: ['printer_diagnostic_tools', 'spare_parts'], seasonal_multiplier: 1.0, seo: { summary: "خدمات إصلاح طابعات سريعة وموثوقة لإعادة مكتبك إلى العمل.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
      { id: 'smart_home_setup', ar_name: 'تركيب وتكوين أنظمة المنزل الذكي', en_name: 'Smart Home Device Setup', urgency: 'scheduled', avg_price_range: [500, 2000], skill_requirements: ['smart_home_integrator'], tools_required: ['smart_hub_configurator', 'device_linker'], seasonal_multiplier: 1.0, seo: { summary: "إعداد وتكوين متخصص لأجهزة المنزل الذكي لتجربة معيشة متصلة.", primary_keywords: [], secondary_keywords: [], long_tail_keywords: [], faq: [] } },
    ],
  };
